...
if __name__ == '__main__':
    from dbenv import MySQLEnv
    from workload import SYSBENCH_WORKLOAD
    workload = SYSBENCH_WORKLOAD
    a = MySQLEnv(workload,'./knob_configs/SYSBENCH_shap.json', knob_num=20)
    l = LHSGenerator(2, a.knobs_detail)
    print(l.generate_results()[0])
